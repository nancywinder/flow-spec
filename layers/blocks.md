...
They make use of the [Expression Specification](https://github.com/nancywinder/flow-spec/tree/7a09ac6d0cd28370fd159bce33d69f61c8eb4c30/layers/expressions.md) for generating content and evaluating decisions.
...
| Key | Description |
| :--- | :--- |
| `test` | The expression to be evaluated. If the expression evaluates to a "truthy" value, the block will terminate through this exit. |
